resource "aws_autoscaling_group" "app1_asg" {
  ...
  vpc_zone_identifier   = [
    ...
    aws_subnet.private-ap-southeast-2-1a.id,
    aws_subnet.private-ap-southeast-2-1b.id,
    aws_subnet.private-us-west-2-1a.id,
    aws_subnet.private-us-west-2-1c.id,
    aws_subnet.private-eu-west-2-1a.id,
    aws_subnet.private-eu-west-2-1b.id,
